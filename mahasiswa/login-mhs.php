<!DOCTYPE html>
   ...
   <body>
      <div class="login">
         <img src="img/login-mhs-bg.jpg" alt="login image" class="login__img">
         ...
         <form method="post" action="logincek.php" class="login__form">
            ...
            <div class="login__content">
               ...
               <div class="login__box">
                  ...
                  <div class="login__box-input">
                     <input type="number" name="nim" required class="login__input" placeholder=" ">
                     <label for="" class="login__label">Nomor Induk Mahasiswa</label>
                  </div>
               </div>
            ...
            <button type="submit" name="simpan" class="login__button">Sign In</button>
