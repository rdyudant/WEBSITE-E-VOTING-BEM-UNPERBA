			 ...
			 <form action="?m=mahasiswa&s=update" method="post" enctype="multipart/form-data">
              <table id="pilkasis1" class="table table-bordered table-hover table-striped">
                <tbody>
					<tr>
						<td width=150>NIM</td>
						<td><input type="number" name="nim" value="<?php echo$r['nim'];?>" readonly /><small></br><b>(NIM tak bisa diubah)</b></small></td>
					</tr>
					<tr>
						<td>Password*</td>
						<td><input type="password" name="password" placeholder=" " maxlength="25px" /><small></br><i>*kosongkan jika password tak diubah</i></small></td>
					</tr>
					<tr>
						<td>Nama Lengkap</td>
						<td><input type="text" name="nama" placeholder=" " maxlength="50px" value="<?php echo$r['nama'];?>" required /></td>
					</tr>
					<tr>
						<td>Jenis Kelamin</td>
					...
					<tr>
						<td>Email</td>
						<td><input type="email" name="email" placeholder=" " maxlength="50px" value="<?php echo$r['email'];?>" /></td>
					</tr>
					<tr>
						<td>Program Studi</td>
						<td>
					...
					<tr>
						...
						<?php
							if ($r['foto'] != '') {
								echo "<img src=\"../gambar/admin/$r[foto]\" height=100 />";
							} else {
								...
								if ($gender == 'L') {
									echo "<img src=\"../gambar/mahasiswa/L.jpg\" height=100 />";
								} elseif ($gender == 'P') {
									echo "<img src=\"../gambar/mahasiswa/P.jpg\" height=100 />";
								} else {
					...
					<tr>
						...
						<a href="?m=mahasiswa" class="btn btn-danger">Cancel</a></td>
					</tr>
                </tbody>
              </table>
			 </form>
