        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            ?>
					...
					<tr>
						<td colspan=2>
						<a href="?m=admin&s=edit&idp=<?php echo$id;?>" class="btn btn-info"><i class="ri-edit-2-line"></i> Edit</a>
						<a href="?m=awal" class="btn btn-danger"><i class="fa fa-times"></i> Close</a></td>
					</tr>
                </tbody>
              </table>
			 </form>
